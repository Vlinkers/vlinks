            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6">
                  ...
                  <span className="text-sm text-muted-foreground">L'histoire vraie</span>
                </div>
                <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                  L'expérience qui a <span className="text-gradient">tout changé</span>
                </h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    <strong className="text-foreground">Septembre 2023.</strong> Un véhicule prometteur sur Kijiji. 
                    Belle présentation, prix raisonnable, vendeur confiant. Tout semblait parfait.
                  </p>
                  <p>
                    <strong className="text-foreground">450$ d'inspection plus tard :</strong> des problèmes de suspension masqués, 
                    des réparations antérieures mal documentées, un historique de maintenance incomplet. L'achat a été abandonné.
                  </p>
                  <p>
                    <strong className="text-foreground">Trois semaines après :</strong> le véhicule était toujours en vente. 
                    Un autre acheteur allait probablement payer une autre inspection, découvrir les mêmes problèmes, 
                    et abandonner à son tour. Un cycle sans fin.
                  </p>
                  <p className="text-foreground font-medium">
                    Cette frustration est devenue une mission : créer un endroit où l'information survit, 
                    où chaque inspection compte, où les acheteurs ne sont plus seuls.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-background/80 backdrop-blur-sm border border-border/50 rounded-3xl p-8 space-y-6">
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-full bg-danger/10 flex items-center justify-center">
                      <DollarSign className="w-8 h-8 text-danger" />
                    </div>
                    <div>
                      <p className="text-3xl font-display font-bold text-danger">450$</p>
                      <p className="text-sm text-muted-foreground">Inspection payée</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-3xl font-display font-bold text-warning">7</p>
                      <p className="text-sm text-muted-foreground">Problèmes découverts</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Personnes informées après</p>
                    </div>
                  </div>
                  <div className="pt-4 border-t border-border/50">
                    <p className="text-sm text-muted-foreground italic">
                      "Le prochain acheteur a probablement payé la même chose pour découvrir les mêmes problèmes."
                    </p>
                  </div>
                </div>
              </div>
